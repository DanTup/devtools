...
///
/// The [DtdEditorServer] class acts as an editor over a DTD connection whereas
/// the `FakePostMessageEditor` class acts as an editor that communicates over
/// postMessage.
...
class DtdEditorServer extends EditorServer {
  ...
  Future<void> _postEvent(EditorEvent params) {
    return _dtd.postEvent(editorStreamName, params.event.name, params.toJson());
  }
